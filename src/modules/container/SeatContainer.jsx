...
export class SeatContainer extends Component {
    render() {
        ...
        return (
            <div>
                {<SeatMap passengerId={this.props.selectedPassengerId}
                    passengerList={this.props.passengerList} flight={this.props.flight}
                    onClick={this.props.onClick} bookedSeatMap={this.props.seatMap} seats={seats} />}
